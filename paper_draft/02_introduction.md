...
For over a century, *Escherichia coli* has served as the foundational bedrock of molecular biology and biotechnology. First isolated in 1885 by the German pediatrician Theodor Escherich from infant feces, the Gram-negative rod-shaped bacterium was initially studied as a harmless commensal organism of the human gut and a minor pathogen. However, by the mid-20th century, *E. coli* had undergone a conceptual transformation, transitioning from a medical specimen to the premier model organism for life sciences. 

---

## 2.1 The Historical Ascent of E. coli

The selection of *E. coli*—specifically the K-12 and B strains—as the default tool for molecular biology was shaped by key technical decisions in the 1940s and 1950s. Joshua Lederberg’s discovery of bacterial conjugation in *E. coli* K-12 in 1946 established that bacteria possessed genetic mechanisms analogous to eukaryotic recombination, making them viable genetic systems. Concurrently, Max Delbrück and the "Phage Group" selected *E. coli* as the host system to study bacteriophage replication, laying the groundwork for molecular genetics. 
...
This historical momentum culminated in 1997 with the publication of the complete genome sequence of *E. coli* K-12 MG1655 by Blattner and colleagues. The sequencing project consolidated *E. coli*'s role as the primary reference point for annotation, functional genomics, and comparative biochemistry.
...
However, this consensus is built upon a qualitative and historical narrative. To date, there has been no quantitative, large-scale literature-wide evaluation of *why* researchers choose to use *E. coli*, nor has anyone measured how often researchers justify this selection in peer-reviewed publications. The scientific community has accepted the model status of *E. coli* as an implicit paradigm, leaving an empirical gap in our understanding of how model organisms are validated and institutionalized in scientific practice.
...
To overcome these limitations, we leverage recent advances in large language models (LLMs) and dense sentence embeddings. By utilizing the **gpt-oss-120b** model running on the **Cerebras Inference API**, we can execute high-fidelity, zero-shot structured extraction of justifications directly from publication abstracts with robust validation mechanisms. Combining this LLM-based claim extraction with transformer-based sentence embeddings (`pritamdeka/S-PubMedBert-MS-MARCO`) and unsupervised density-based clustering (UMAP + HDBSCAN) allows us to identify the underlying thematic structure of scientific justifications at a scale previously impossible.

---

## 2.4 Research Scope and Questions

To contextualize *E. coli*'s premier status, we employ a comparative framework. We analyze *E. coli* literature alongside two major control microorganisms:
...
Our corpus comprises **3,273 unique peer-reviewed papers** (2,051 *E. coli*, 950 *S. cerevisiae*, and 272 *B. subtilis*) published between 1990 and 2025. Through this computational comparative analysis, we address five primary research questions:
